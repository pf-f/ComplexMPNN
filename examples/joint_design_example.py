...
Function：演示Joint-designMode的蛋白质sequence设计
同时设计Allchain的sequence
...
def design_joint(model, seq_idx, backbone_coords):
    """
    使用Joint-designMode设计蛋白质sequence
    ...
    # Joint-designMode：Allresidue都可设计
...
def main():
    """主Function"""
    parser = argparse.ArgumentParser(description='Joint-designModesequence设计示例')
    ...
    print(f"可设计residueCount: {seq_len} (Allresidue)")
    
    # 进行设计
    print("\nStartJoint-designMode设计...")
    ...
    print("\n✅ Joint-designMode设计Complete！")
    print("\n说明:")
    print("  - 本示例使用模拟Data演示Joint-designMode")
    print("  - 实际使用时，请load真实的蛋白质结构Data")
    print("  - Joint-designMode中Allresidue都可以设计")
    print("  - 适用于同时优化protein complexes的Allchain")
